...
1.  [x] You should have a div with a class of form-container to hold your form.
2.  [x] You should have a form element within the .form-container element.
3.  [x] Within the form element, you should have the following elements and input fields:
