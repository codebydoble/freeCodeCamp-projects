...
1. [x] You should have a div element with a class of blog-post-card to hold all of your card elements.
2. [x] Within the .blog-post-card element, you should have an image element with a valid alt attribute and text, and a class of post-img. You can use https://cdn.freecodecamp.org/curriculum/labs/cover-photo.jpg for the src attribute of the image.
3. [x] You should have a div with a class of post-content within the .blog-post-card element with the following:
...
4. [x] You should apply the following styles to the .blog-post-card element:
    - A white background.
    - Rounded corners.
...
_Note_: Be sure to link your stylesheet in your HTML and apply your CSS.
